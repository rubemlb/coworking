...
$expected = ['nome', 'telefone', 'email','local','tipologia','mensagem'];
$required = ['nome', 'telefone', 'email','local','tipologia','mensagem'];
    ...
    try {
      // create a transport
        ...
        $message = Swift_Message::newInstance()
            ...
            $image_logo = $message->embed(Swift_Image::fromPath('img/portfolio/coworkinglogo.png'));
...
<title>Coworking by prime</title>
</head>
